...
{
    public class TblMasterCompanyProfile
    {
        [Key]
        ...
        public string CompanyProfileStateCode { get; set; }
        ...
        public int? CompanyProfileStateStId { get; set; }
        public string CompanyProfileStateName { get; set; }
    }
}
